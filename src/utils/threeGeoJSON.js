...
export const drawThreeGeo = (json, radius, shape, materalOptions, container, THREE) => {
  ...
  for (var geom_num = 0; geom_num < json_geom.length; geom_num++) {
      ...
      if (json_geom[geom_num].type == 'Point') {
          ...
          drawParticle(x_values[0], y_values[0], z_values[0], materalOptions, THREE);
          ...
          drawLine(x_values, y_values, z_values, materalOptions, THREE);
  ...
  function drawParticle(x, y, z, options, THREE) {
  ...
  function drawLine(x_values, y_values, z_values, options, THREE) {
  ...
  function createVertexForEachPoint(object_geometry, values_axis1, values_axis2, values_axis3, THREE) {
